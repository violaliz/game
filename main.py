...
class Player(arcade.Sprite):
    def __init__(self):
        super().__init__(':resources:images/enemies/fly.png', SPRITE_SCALING_PLAYER)
...
class Laser(arcade.Sprite):
    def __init__(self):
        super().__init__(':resources:images/topdown_tanks/treeGreen_small.png', SPRITE_SCALING_LASER, angle=180)
        self.change_y = 2
...
class Enemy(arcade.Sprite):
    def __init__(self):
        super().__init__(':resources:images/enemies/wormGreen_move.png', SPRITE_SCALING_ENEMY, angle=90)
        self.change_y = 1
...
class Game(arcade.Window):
    def __init__(self):
        ...
        self.background_texture = arcade.load_texture(':resources:images/backgrounds/abstract_2.jpg')
